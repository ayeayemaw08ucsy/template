...
@Getter
@Setter
@Table(name = "BBI_POSTINGS_TNX")
@NoArgsConstructor
public class PostingTxn {
	...
	public PostingTxn(String entity, String prodCode, String prodRefId, String businessDate, String debitCcy,
